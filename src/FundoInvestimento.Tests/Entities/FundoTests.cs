...
namespace FundoInvestimento.Tests.Entities
{
    ...
    public class FundoTests
    {
        ...
        [InlineData(100, 100, StatusCaptacao.ABERTO, false)] // Fundo fechado
        public void AceitaAporte_DeveRetornarEsperado_BaseadoNoStatusEValorMinimo(
        decimal valorAporte, decimal valorMinimoAporte, StatusCaptacao status, bool resultadoEsperado)
        {
            // Arrange
            var fundo = new Fundo(
                nome: "Fundo Teste",
        ...
        [InlineData("14:00:00", "14:00:00", true)]  // Horário limite
        [InlineData("14:00:01", "14:00:00", false)] // Depois do horário
        public void DentroDoHorarioDeCorte_DeveRetornarEsperado_BaseadoNoHorario(
        string horaAtualStr, string horarioCorteStr, bool resultadoEsperado)
        {
            // Arrange
        ...
        [Theory]
        [InlineData(100, 100, 50, true)]  // Resgate total
        [InlineData(100, 50, 50, true)]   // Resgate parcial, saldo remanescente igual ao mínimo
        [InlineData(100, 40, 50, true)]   // Resgate parcial, saldo remanescente maior que o mínimo
        [InlineData(100, 60, 50, false)]  // Resgate parcial, saldo remanescente menor que mínimo
        public void ResgateDeixaSaldoValido_DeveRetornarEsperado_BaseadoNoSaldoRemanescente(
            decimal saldoAtual, decimal valorResgate, decimal valorMinimoPermanencia, bool resultadoEsperado)
        {
            // Arrange
            var fundo = new Fundo(
                nome: "Fundo Teste",
